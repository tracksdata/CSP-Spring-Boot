...
public class BillerImpl {
	 ...
	 * memory issues -> per issues
	 * 
	 * Why this issue happened? -------------------------- -> Dependent class itself
	 * creating Dependency class object
	 * 
	 * what is the solution? ---------------------- -> Do not create dependency
	 * class object in the dependent -> Find the object using JNDI technique
	 * 
	 * -> JNDI location is tightly binded with dependent class
	 * 
	 * What is the best solution? ---------------------------- -> Do create create,
	 * do not find, instead ask some one (like containers/providers) -> IoC
	 * (Inversion of control)
	 * 
	 * -> DI (Dependency Injection) -> Injecting/passing dependency object to
	 * dependent class
	 * 
	 * DI can be done with two ways 1. using setter based DI 2. using constructor
	 * based DI
	 */
